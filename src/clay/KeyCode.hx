...
enum abstract KeyCode(Int) from Int to Int {
    ...
    public static function toScanCode(keycode:KeyCode):ScanCode {
        ...
        switch (keycode:Int) {
            case 13  /*Keycodes.enter*/:         return ScanCode.ENTER;
            case 27  /*Keycodes.escape*/:        return ScanCode.ESCAPE;
            case 8   /*Keycodes.backspace*/:     return ScanCode.BACKSPACE;
            case 9   /*Keycodes.tab*/:           return ScanCode.TAB;
            case 32  /*Keycodes.space*/:         return ScanCode.SPACE;
            case 47  /*Keycodes.slash*/:         return ScanCode.SLASH;
            case 48  /*Keycodes.key_0*/:         return ScanCode.KEY_0;
            case 49  /*Keycodes.key_1*/:         return ScanCode.KEY_1;
            case 50  /*Keycodes.key_2*/:         return ScanCode.KEY_2;
            case 51  /*Keycodes.key_3*/:         return ScanCode.KEY_3;
            case 52  /*Keycodes.key_4*/:         return ScanCode.KEY_4;
            case 53  /*Keycodes.key_5*/:         return ScanCode.KEY_5;
            case 54  /*Keycodes.key_6*/:         return ScanCode.KEY_6;
            case 55  /*Keycodes.key_7*/:         return ScanCode.KEY_7;
            case 56  /*Keycodes.key_8*/:         return ScanCode.KEY_8;
            case 57  /*Keycodes.key_9*/:         return ScanCode.KEY_9;
            case 59  /*Keycodes.semicolon*/:     return ScanCode.SEMICOLON;
            case 61  /*Keycodes.equals*/:        return ScanCode.EQUALS;
            case 91  /*Keycodes.leftbracket*/:   return ScanCode.LEFTBRACKET;
            case 92  /*Keycodes.backslash*/:     return ScanCode.BACKSLASH;
            case 93  /*Keycodes.rightbracket*/:  return ScanCode.RIGHTBRACKET;
            case 96  /*Keycodes.backquote*/:     return ScanCode.GRAVE;
            case 97  /*Keycodes.key_a*/:         return ScanCode.KEY_A;
            case 98  /*Keycodes.key_b*/:         return ScanCode.KEY_B;
            case 99  /*Keycodes.key_c*/:         return ScanCode.KEY_C;
            case 100 /*Keycodes.key_d*/:         return ScanCode.KEY_D;
            case 101 /*Keycodes.key_e*/:         return ScanCode.KEY_E;
            case 102 /*Keycodes.key_f*/:         return ScanCode.KEY_F;
            case 103 /*Keycodes.key_g*/:         return ScanCode.KEY_G;
            case 104 /*Keycodes.key_h*/:         return ScanCode.KEY_H;
            case 105 /*Keycodes.key_i*/:         return ScanCode.KEY_I;
            case 106 /*Keycodes.key_j*/:         return ScanCode.KEY_J;
            case 107 /*Keycodes.key_k*/:         return ScanCode.KEY_K;
            case 108 /*Keycodes.key_l*/:         return ScanCode.KEY_L;
            case 109 /*Keycodes.key_m*/:         return ScanCode.KEY_M;
            case 110 /*Keycodes.key_n*/:         return ScanCode.KEY_N;
            case 111 /*Keycodes.key_o*/:         return ScanCode.KEY_O;
            case 112 /*Keycodes.key_p*/:         return ScanCode.KEY_P;
            case 113 /*Keycodes.key_q*/:         return ScanCode.KEY_Q;
            case 114 /*Keycodes.key_r*/:         return ScanCode.KEY_R;
            case 115 /*Keycodes.key_s*/:         return ScanCode.KEY_S;
            case 116 /*Keycodes.key_t*/:         return ScanCode.KEY_T;
            case 117 /*Keycodes.key_u*/:         return ScanCode.KEY_U;
            case 118 /*Keycodes.key_v*/:         return ScanCode.KEY_V;
            case 119 /*Keycodes.key_w*/:         return ScanCode.KEY_W;
            case 120 /*Keycodes.key_x*/:         return ScanCode.KEY_X;
            case 121 /*Keycodes.key_y*/:         return ScanCode.KEY_Y;
            case 122 /*Keycodes.key_z*/:         return ScanCode.KEY_Z;
