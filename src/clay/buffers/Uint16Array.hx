...
// Credits go to its original author (@ruby0x1 on Github)
    ...
    @:forward
    abstract Uint16ArrayImplJS(js.lib.Uint16Array)
    ...
    typedef Uint16Array = Uint16ArrayImplJS;
    ...
    @:forward
    abstract Uint16ArrayImpl(ArrayBufferView) from ArrayBufferView to ArrayBufferView {
        ...
        static public inline function fromBuffer(_buffer:ArrayBuffer, _byteOffset:Int, _byteLength:Int, ?_view:ArrayBufferView) : Uint16Array {
            return ArrayBufferView.fromBuffer(Uint16, _buffer, _byteOffset, _byteLength, _view);
        }
    ...
    typedef Uint16Array = Uint16ArrayImpl;
