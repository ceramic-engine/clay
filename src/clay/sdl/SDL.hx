...
class SDL {
    ...
    @:native('LINC_SDL_EVENT_WINDOW_MINIMIZED') public static inline var SDL_EVENT_WINDOW_MINIMIZED:UInt32 = 0x208;
    @:native('LINC_SDL_EVENT_WINDOW_MAXIMIZED') public static inline var SDL_EVENT_WINDOW_MAXIMIZED:UInt32 = 0x209;
    @:native('LINC_SDL_EVENT_WINDOW_RESTORED') public static inline var SDL_EVENT_WINDOW_RESTORED:UInt32 = 0x20A;
    @:native('LINC_SDL_EVENT_WINDOW_MOUSE_ENTER') public static inline var SDL_EVENT_WINDOW_MOUSE_ENTER:UInt32 = 0x20B;
    @:native('LINC_SDL_EVENT_WINDOW_MOUSE_LEAVE') public static inline var SDL_EVENT_WINDOW_MOUSE_LEAVE:UInt32 = 0x20C;
    @:native('LINC_SDL_EVENT_WINDOW_FOCUS_GAINED') public static inline var SDL_EVENT_WINDOW_FOCUS_GAINED:UInt32 = 0x20D;
    @:native('LINC_SDL_EVENT_WINDOW_FOCUS_LOST') public static inline var SDL_EVENT_WINDOW_FOCUS_LOST:UInt32 = 0x20E;
    @:native('LINC_SDL_EVENT_WINDOW_CLOSE_REQUESTED') public static inline var SDL_EVENT_WINDOW_CLOSE_REQUESTED:UInt32 = 0x20F;
    @:native('LINC_SDL_EVENT_WINDOW_HIT_TEST') public static inline var SDL_EVENT_WINDOW_HIT_TEST:UInt32 = 0x210;
    @:native('LINC_SDL_EVENT_WINDOW_ICCPROF_CHANGED') public static inline var SDL_EVENT_WINDOW_ICCPROF_CHANGED:UInt32 = 0x211;
    @:native('LINC_SDL_EVENT_WINDOW_DISPLAY_CHANGED') public static inline var SDL_EVENT_WINDOW_DISPLAY_CHANGED:UInt32 = 0x212;
    @:native('LINC_SDL_EVENT_WINDOW_DISPLAY_SCALE_CHANGED') public static inline var SDL_EVENT_WINDOW_DISPLAY_SCALE_CHANGED:UInt32 = 0x213;
    @:native('LINC_SDL_EVENT_WINDOW_SAFE_AREA_CHANGED') public static inline var SDL_EVENT_WINDOW_SAFE_AREA_CHANGED:UInt32 = 0x214;
    @:native('LINC_SDL_EVENT_WINDOW_OCCLUDED') public static inline var SDL_EVENT_WINDOW_OCCLUDED:UInt32 = 0x215;
    @:native('LINC_SDL_EVENT_WINDOW_ENTER_FULLSCREEN') public static inline var SDL_EVENT_WINDOW_ENTER_FULLSCREEN:UInt32 = 0x216;
    @:native('LINC_SDL_EVENT_WINDOW_LEAVE_FULLSCREEN') public static inline var SDL_EVENT_WINDOW_LEAVE_FULLSCREEN:UInt32 = 0x217;
    @:native('LINC_SDL_EVENT_WINDOW_DESTROYED') public static inline var SDL_EVENT_WINDOW_DESTROYED:UInt32 = 0x218;
    @:native('LINC_SDL_EVENT_WINDOW_HDR_STATE_CHANGED') public static inline var SDL_EVENT_WINDOW_HDR_STATE_CHANGED:UInt32 = 0x219;
